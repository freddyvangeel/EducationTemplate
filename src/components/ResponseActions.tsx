...
interface ResponseActionsProps {
  ...
  isStreaming?: boolean
  className?: string
  showOnlyTTS?: boolean // New prop to control which actions to show
}
...
export default function ResponseActions({ 
  ...
  isStreaming = false,
  className = "",
  showOnlyTTS = false // Default to false for backward compatibility
  ...
  return (
    <div className={`mt-3 ${className}`}>
      {/* Only show TTS controls - no copy or download buttons */}
